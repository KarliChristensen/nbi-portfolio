  ...
  workLinks: [
    {
      ...
      text: `Starting with the Ironhack Bootcamp, I spent 6 months learning the essentials before volunteering my work to old contacts. Some of those projects are listed here.`,
      tools: [],
    },
    {
      time: [2018, 2022],
      ...
      subtitle: "Co-Founder",
      text: "After collaborating with other freelancers, and finding that we were mutually benefitting from sharing skills, know-how and clients, we eventually came together under the banner Crowd-Collective and operated as a communally driven informal digital bureau.",
      tools: [],
    },
    {
      time: [2013, 2023],
