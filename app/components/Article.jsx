    ...
    <article className="article md:px-0 w-full md:py-20 flex justify-center">
      <div className="group relative w-full">
        <div className="articleDiv relative flex justify-center items-center">
          <Image
            className="md:w-[90%] md:max-w-[80%] imgTilt"
            src={imageOne}
        ...
        <div className="articleSecondaryDiv w-[40%] max-w-[1200px] bottom-[-25%] right-[10%] absolute hidden md:block z-10">
          <Image
            className="z-10 imgTiltTwo"
            src={imageTwo}
            alt="Secondary article image"
          />
          <div className="flex flex-col w-[80%] absolute -z-20 bottom-[15%] left-[10%] transform group-hover:-translate-x-[95%] duration-1000 ease-in-out space-y-1 ">
            <h1 className="font-bold text-lg">{Title}</h1>
            <span className="w-[90%] h-[1px] bg-black"></span>
            <div className="flex justify-between w-[75%]">
              <h2 className="w-fit">{Subtitle}</h2>
              <div className="flex flex-row justify-between w-14">
                <svg
                  className="stroke-slate-500 opacity-60 stroke-[0.5px] hover:stroke-black hover:opacity-100 transform ease-in-out duration-300"
                  height={25}
                  viewBox="0 0 24 24"
