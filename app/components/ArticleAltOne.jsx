    ...
    <article className="article md:px-0 w-full md:py-20 flex justify-center">
      <div className="relative flex justify-center w-full m-5 md:m-0">
        <div className="articleDiv group w-full flex justify-center items-center ">
          <figure className="overlayHover w-full md:w-[80%] lg:w-[60%] max-w-[1000px] imgTiltAlt">
            <Image
            ...
            <div className="md:hidden absolute bottom-0 group-hover:translate-y-20 transform duration-300 ease-in-out w-full h-full rounded-2xl -z-10 bg-black/50">
              <div className="flex items-end justify-center h-full w-full pb-5">
                <a
                ...
                <a
                  className="w-[39px]"
                  href={deployment}
                  aria-label="Link to deployed version of site"
                >
                  <svg
                    className="w-full fill-white hover:fill-slate-500 transform duration-300 ease-in-out"
                    viewBox="0 0 24 24"
        ...
        <div className="articleSecondaryDiv w-full absolute hidden bottom-[-20%] inset-x-[27%] md:block z-1">
          <div className="max-w-[450px] md:max-w-[350px]">
            <figure className="overlayHover w-full max-w-[1000px] imgTiltTwoAlt">
              <Image
                className="overlayHover"
                src={imageTwo}
