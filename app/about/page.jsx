...
function page() {
  return (
    <>
      <Head>
        <title>Karli Christensen - About</title>
        <meta
          name="description"
      ...
      >
        <div className="ml-[15%] md:w-[60%] lg:w-[70%]">
          <p className="text-white font-serif font-bold text-xl md:text-3xl leading-9 mr-8 md:mr-14">
            Hi, I&#39;m Karli! <br />
            <br />
            Back in 2019 when Covid wasn&#39;t yet a concern I made my living as
            a translator, subtitler, copywriter, and transcriptionist. The
            pandemic came and went, and with the world changing, and my clients
            ...
            Since 2023 I&#39;ve been providing mediocre front-end code
            containing excellent copywriting and exquisite flow while I still
            find my feet in the industry.
          </p>
          <div className="py-10">
            <a
            ...
            >
              <svg
                className="stroke-white fill-white w-6 mr-1"
                viewBox="0 0 512 512"
